...
const PRESENT_INTRO = [
  ...
  '',
  'The rows are final. Nothing in this mode can change them — no aggregating, filtering, trimming, reordering or',
  'deriving — and the order they are in is the order to show. Do not ask for different rows, and do not recompute a',
