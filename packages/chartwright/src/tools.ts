...
const SUBMIT_PROPERTIES = {
  ...
  encodings: {
    ...
    properties: {
      ...
      size: { type: 'object', required: ['field'], properties: { field: { type: 'string' } }, additionalProperties: false,
        description: 'Size channel for bubble charts — maps a measure to mark size.' },
